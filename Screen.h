...
private:
    ...
    // fonction pour les couleur des careaux
...
// pour les fichiers photos se trouvant dans assets
    ...
    // pour la fin du jeux
		GAMEOVER2="Press ENTER to restart", CLOSE1 = "Press ENTER to exit", CLOSE2="Press S to restart",  PAUSE="P to Pause", RESUME="or Resume";// faire une pause dans le jeu
